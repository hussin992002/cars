        ...
        if (q === '3') {
            return (
                <>
                    ...
                    <p>
                        سيكون هناك معك أدوات الإسعافات الأولية في السيارة: ، مثل قفازات طبية وشرائط طبية وماء بارد الأدوية اللازمة لأمراض متعددة ادوات صحية
                    </p>
                    <p>
                        تعلم تقنيات الإسعافات الأولية*: يجب أن تعلم تقنيات الإسعافات الأولية، مثل تقنية CPR وطريقة استخدام الأدوية الطبية
                    </p>
                    <p>

                        احتفظ بهاتفك قريبًا: يجب أن تحتفظ بهاتفك قريبًا لاستدعاء المساعدة في حالة الطوارئ
                    </p>
                </>
            )
        }
        if (q === '4') {
            return (
                <>
                    ...
                    <p>
                        الطوارئ الجوية_: 2455
                    </p>
                    <p>
                        الطوارئ على الطرق_: 16016
                    </p>
                    <p>
                        نصائح إضافية
                        _احتفظ بأرقام الاستدعاء الطارئة_: احتفظ بأرقام الاستدعاء الطارئة في هاتفك أو في مكان يمكنك الوصول إليه بسهولة.
                        _تعلم كيفية استدعاء الطوارئ_: تعلم كيفية استدعاء الطوارئ في مصر.
                        _كن واضحًا_: كن واضحًا عند استدعاء الطوارئ، وأخبرهم عن حالتك وموقعك.
                    </p >
                </>
